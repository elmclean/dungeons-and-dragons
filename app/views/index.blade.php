...
<div class="row">
	<div class="col-xs-12">
		<h3>The Latest Official Campaign</h3>
		<img class="col-xs-6 img-responsive" src="http://dnd.wizards.com/sites/default/files/media/images/icon/Force%20Grey.jpg">
		<p>Hill giants are stealing all the grain and livestock they can while stone giants have been scouring settlements that have been around forever. Fire giants are press-ganging the smallfolk into the desert, while frost giant longships have been pillaging along the Sword Coast. Even the elusive cloud giants have been witnessed, their wondrous floating cities appearing above Waterdeep and Baldur’s Gate. Where is the storm giant King Hekaton, who is tasked with keeping order among the giants?</p>

		<p>The humans, dwarves, elves, and other small folk of the Sword Coast will be crushed underfoot from the onslaught of these giant foes. The only chance at survival is for the small folk to work together to investigate this invasion and harness the power of rune magic, the giants’ weapon against their ancient enemy the dragons. The only way the people of Faerun can restore order is to use the giants’ own power against them.</p>

		<a href="http://dnd.wizards.com/dungeons-and-dragons/story/storm-kings-thunder" class="btn btn-outline btn-primary">Learn More <i class="glyphicon glyphicon-chevron-right"></i></a>
	</div>
</div>
